...
# shim defaults to github:okuzpe/midas-harness#v2.4.0
```

**Windows (PowerShell)**
```powershell
irm https://raw.githubusercontent.com/okuzpe/midas-harness/main/install.ps1 | iex
# shim defaults to #v2.4.0
```

**Any platform, no shell script** (works with every package manager):
```bash
npx  github:okuzpe/midas-harness#v2.4.0   # recommended — pinned
pnpm dlx github:okuzpe/midas-harness#v2.4.0
bunx github:okuzpe/midas-harness#v2.4.0
```
...
npx github:okuzpe/midas-harness#v2.4.0 --update --yes             # refresh in CI
...
|-----------|----------|----------------|
| **Never installed Midas** | `npx github:okuzpe/midas-harness#v2.4.0 --tools=cursor` | `/midas-init` |
...
| Existing 1.x classic/compact/hub | `npx ...#v2.4.0 --migrate` then add `--apply` | `/midas-status` |
| Engine refresh on v2 | `npx ...#v2.4.0 --update` **or** `/midas-update` (pick one) | `/midas-status` when CLI prints `verify: ok` |
...
```bash
npx github:okuzpe/midas-harness#v2.4.0 --update
npx github:okuzpe/midas-harness#v2.4.0 --update --tools=cursor
```
...
```powershell
npx github:okuzpe/midas-harness#v2.4.0 --migrate
npx github:okuzpe/midas-harness#v2.4.0 --migrate --apply
...
`npx github:okuzpe/midas-harness#v2.4.0 --uninstall`.
