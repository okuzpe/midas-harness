...
|-----------|----------|----------------|
| **Never installed Midas** | `npx github:okuzpe/midas-harness#v2.0.0-rc.1 --tools=cursor` | `/midas-init` |
...
| Existing 1.x classic/compact/hub | `npx ...#v2.0.0-rc.1 --migrate` then add `--apply` | `/midas-status` |
| Engine refresh on v2 | `npx ...#v2.0.0-rc.1 --update` | `/midas-update` (optional diff-confirm) |
...
markers. A modified `vendor` file aborts the update before any write. Adapters re-render for the tools
already listed in state (`--tools` is not applied):

```bash
npx github:okuzpe/midas-harness#v2.0.0-rc.1 --update
```
...
```powershell
npx github:okuzpe/midas-harness#v2.0.0-rc.1 --migrate
npx github:okuzpe/midas-harness#v2.0.0-rc.1 --migrate --apply
...
`npx github:okuzpe/midas-harness#v2.0.0-rc.1 --uninstall`.
