...
# shim defaults to github:okuzpe/midas-harness#v2.3.6
```

**Windows (PowerShell)**
```powershell
irm https://raw.githubusercontent.com/okuzpe/midas-harness/main/install.ps1 | iex
# shim defaults to #v2.3.6
```

**Any platform, no shell script** (works with every package manager):
```bash
npx  github:okuzpe/midas-harness#v2.3.6   # recommended — pinned
pnpm dlx github:okuzpe/midas-harness#v2.3.6
bunx github:okuzpe/midas-harness#v2.3.6
```
...
npx github:okuzpe/midas-harness#v2.3.6 --update --yes             # refresh in CI
...
|-----------|----------|----------------|
| **Never installed Midas** | `npx github:okuzpe/midas-harness#v2.3.6 --tools=cursor` | `/midas-init` |
...
| Existing 1.x classic/compact/hub | `npx ...#v2.3.6 --migrate` then add `--apply` | `/midas-status` |
| Engine refresh on v2 | `npx ...#v2.3.6 --update` **or** `/midas-update` (pick one) | `/midas-status` when CLI prints `verify: ok` |
...
```bash
npx github:okuzpe/midas-harness#v2.3.6 --update
npx github:okuzpe/midas-harness#v2.3.6 --update --tools=cursor
```
...
```powershell
npx github:okuzpe/midas-harness#v2.3.6 --migrate
npx github:okuzpe/midas-harness#v2.3.6 --migrate --apply
...
`npx github:okuzpe/midas-harness#v2.3.6 --uninstall`.
