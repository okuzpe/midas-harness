...
# shim defaults to github:okuzpe/midas-harness#v2.3.4
```

**Windows (PowerShell)**
```powershell
irm https://raw.githubusercontent.com/okuzpe/midas-harness/main/install.ps1 | iex
# shim defaults to #v2.3.4
```

**Any platform, no shell script** (works with every package manager):
```bash
npx  github:okuzpe/midas-harness#v2.3.4   # recommended — pinned
pnpm dlx github:okuzpe/midas-harness#v2.3.4
bunx github:okuzpe/midas-harness#v2.3.4
```
...
npx github:okuzpe/midas-harness#v2.3.4 --update --yes             # refresh in CI
...
|-----------|----------|----------------|
| **Never installed Midas** | `npx github:okuzpe/midas-harness#v2.3.4 --tools=cursor` | `/midas-init` |
...
| Existing 1.x classic/compact/hub | `npx ...#v2.3.4 --migrate` then add `--apply` | `/midas-status` |
| Engine refresh on v2 | `npx ...#v2.3.4 --update` **or** `/midas-update` (pick one) | `/midas-status` when CLI prints `verify: ok` |
...
```bash
npx github:okuzpe/midas-harness#v2.3.4 --update
npx github:okuzpe/midas-harness#v2.3.4 --update --tools=cursor
```
...
```powershell
npx github:okuzpe/midas-harness#v2.3.4 --migrate
npx github:okuzpe/midas-harness#v2.3.4 --migrate --apply
...
`npx github:okuzpe/midas-harness#v2.3.4 --uninstall`.
