...
This example remains a **content fixture** (`.harness/` layout). For the P0 control-plane pilot, copy
...
- [ ] `midas-autopilot setup` + `dry-run` green (editor: `/midas-auto-sprints`)
