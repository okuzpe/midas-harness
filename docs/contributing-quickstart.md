...
| Installer | `cli/index.mjs` + `cli/lib/**` (npm name `create-midas`) | `npm test` |
| Docs | `docs/*`, `INSTALL.md`, `SECURITY.md` | `mkdocs build --strict` (optional) |
| Version | never hand-edit pins | `npm run bump -- X.Y.Z` |

**Do not edit:** `.claude/`, `.agents/`, `.cursor/skills/`, `harness/plugins/midas/`, `harness/.claude-plugin/`, `cli/template/`, adapter digests.
