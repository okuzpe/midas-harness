...
Install:
  ...
  npx github:okuzpe/midas-harness my-app   into ./my-app
  npx github:okuzpe/midas-harness#v0.5.8   pin a release for a reproducible install
...
Update an existing install (overwrites the engine, KEEPS your work, bumps the version stamp):
  ...
  npx github:okuzpe/midas-harness#v0.5.8 --update      refresh to a pinned release
