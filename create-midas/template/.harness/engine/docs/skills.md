...
Every skill is a markdown file under `.claude/skills/<name>/SKILL.md` (engine: `harness/skills/`).
...
| `/midas-update` | Setup | Migrate install to current engine (dry-run + confirm). | build |
...
| Edited engine / installer / skills / VERSION | `/midas-align` |
