...
metadata:
  midas-argument-hint: "[the pattern to capture] [--as rule|playbook|convention]"
...
- Record the capture in **`paths.state`** (the artifact path + a one-line "captured from a repeated request"
