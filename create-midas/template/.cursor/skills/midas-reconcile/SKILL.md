...
|-------------|-------------|
| No `.harness/engine/VERSION`, `harness/VERSION`, or `.midas/engine/VERSION` | `npx github:okuzpe/midas-harness#v2.0.0-rc.4 --tools=cursor` then `/midas-init` |
| `harness/VERSION` or `.midas/engine/VERSION` exists but canonical engine does not | Preview `npx ...#v2.0.0-rc.4 --migrate`; after review add `--apply` |
