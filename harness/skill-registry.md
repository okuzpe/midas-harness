...
| `midas-precommit` | engine | orchestrator-only | engine-only | `skills/midas-precommit/SKILL.md` |
...
| `midas-sandbox` | engine | orchestrator-only | engine-only | `skills/midas-sandbox/SKILL.md` |
