...
| **STM** | working memory this stretch | `{runs}/sprints/NN-progress.md`, `{runs}/auto-pilot/journal.md`, active sprint file | build tier during Phase 7 or `/midas-auto-pilot` |
...
Copy `<paths.engine>/templates/sprint-progress.md` to
