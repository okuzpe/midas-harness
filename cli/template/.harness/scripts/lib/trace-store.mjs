// trace-store.mjs — JSONL + current.json under {paths.cache}/traces (ADR-010).
...
export function resolveTracesRoot(projectRoot) {
  ...
  const cacheRoot = paths.cache || join(paths.runs, 'cache');
  return join(projectRoot, cacheRoot, 'traces');
}
